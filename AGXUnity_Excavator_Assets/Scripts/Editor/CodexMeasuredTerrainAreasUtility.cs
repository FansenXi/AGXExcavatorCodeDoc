...
namespace AGXUnity_Excavator.Scripts.Editor
{
  ...
  public static class CodexMeasuredTerrainAreasUtility
  {
    ...
    private const float DigSoilHeight = 0.6f * EnvironmentScale;
    private const float TerrainVerticalScale = 1.4f * EnvironmentScale;
    private const float TerrainMaximumDepth = 0.7f * EnvironmentScale;
