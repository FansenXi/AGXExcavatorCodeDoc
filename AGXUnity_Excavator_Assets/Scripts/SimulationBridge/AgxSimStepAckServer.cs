...
namespace AGXUnity_Excavator.Scripts.SimulationBridge
{
  public class AgxSimStepAckServer : MonoBehaviour
  {
    ...
    private ExcavatorActuationCommand m_lastRequestedActuationCommand = ExcavatorActuationCommand.Zero;
    private bool m_hasReceivedStepCommand = false;
    ...
    private byte[] CreateStepResponse( AgxSimRequestPayload request )
    {
      ...
      var actuationCommand = new ExcavatorActuationCommand
      {
      ...
      m_lastRequestedActuationCommand = actuationCommand;
      m_hasReceivedStepCommand = true;
      m_machineController?.ApplyActuationCommand( actuationCommand );
    ...
    private void ResetStepCommandState()
    {
      m_lastRequestedActuationCommand = ExcavatorActuationCommand.Zero;
      m_hasReceivedStepCommand = false;
    }
