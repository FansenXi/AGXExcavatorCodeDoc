  ...
  public static class CodexFactoryRoofUtility
  {
    ...
    private static void ApplyFactoryRoof( string source )
    {
      ...
      try {
        ...
        const float roofExtensionHeight = 1.0f * CodexSceneScaleConfig.DefaultEnvironmentScale;
        const float roofThickness = 0.10f * CodexSceneScaleConfig.DefaultEnvironmentScale;
