...
namespace AGXUnity_Excavator.Scripts.SimulationBridge
{
  ...
  public class PlannerDebugSnapshot
  {
    ...
    public float current_bucket_dig_area_x_m = 0.0f;
    public float current_bucket_dig_area_y_m = 0.0f;
    public float current_bucket_dig_area_z_m = 0.0f;
    public bool current_bucket_tip_valid = false;
    public float current_bucket_tip_dig_area_x_m = 0.0f;
    public float current_bucket_tip_dig_area_y_m = 0.0f;
    public float current_bucket_tip_dig_area_z_m = 0.0f;
    ...
    public bool HasCoverageDecision =>
      ...
      ( string.Equals( mode, "operator_prior_coverage", StringComparison.Ordinal ) ||
        string.Equals( mode, "operator_prior_sweep_belief", StringComparison.Ordinal ) ) &&
